    ...
    displayLogin = (
      <>
        <div className="h-full w-full flex ">
          ...
          <div className="relative md:absolute h-5/6 lg:h-[97%] rounded-bl-2xl w-full md:w-3/4 right-0 z-10 bg-IjoRumput bg-opacity-85 md:bg-opacity-100 md:bg-white">
                ...
                {userType === "mahasiswa" ? (
                  <>
                    ...
                    >
                        ...
                        <div className="relative">
                          <div className="w-full">
                            <input
                              ...
                              className="block text-xs md:text-sm lg:text-base w-full px-4 py-2 mt-2 text-gray-700 bg-gray-100 focus:bg-gray-50 border rounded-md focus:border-IjoRumput focus:ring-IjoRumput focus:outline-none focus:ring focus:ring-opacity-40"
                            />
                          </div>
                      ...
                      <div className="mt-2">
                        <button className="w-full text-sm md:text-base px-4 py-2 tracking-wide text-white font-bold transition-colors duration-200 transform bg-IjoRumput border-IjoRumput rounded-md hover:bg-white hover:text-IjoRumput border">
                          Login
                        </button>
                      </div>
                    </form>
